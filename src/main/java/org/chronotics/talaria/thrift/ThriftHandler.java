...
public interface ThriftHandler extends TransferService.Iface {
}
...
//		MessageQueue<Message> msgqueue = (MessageQueue<Message>) 
...
////			map.put(ThriftHandler.arg,(Object)_v);
////			executeHandler(map);
////		} catch (Exception e) {
...
//			map.put(ThriftHandler.arg,(Object)_receiver_id);
